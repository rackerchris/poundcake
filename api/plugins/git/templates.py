...
GIT_INGREDIENT_TEMPLATES: tuple[JSONObject, ...] = (
    {
        "service_type": "git",
        "service_exec": "health_check",
        "destination_target": "git",
        "task_key_template": "git-health-check",
    ...
    },
    {
        ...
        "service_exec_parameters": {
            ...
            "operation_metadata": {
                "read_file": {"label": "Read file", "description": "Read one repository file."},
                "list_files": {
                    "label": "List files",
    ...
    },
    {
        ...
        "service_exec_parameters": {
            ...
            "operation_metadata": {
                "commit_files": {"label": "Commit files", "description": "Commit Git changes."},
                "create_pull_request": {
                ...
                "commit_and_pr": {
                    "label": "Commit and PR",
                    "description": "Commit Git changes and open a pull request.",
                },
            },
        },
...
GIT_RECIPE_TEMPLATES: tuple[JSONObject, ...] = (
    {
        "name": "plugin-health-check:git",
        "description": "Scheduled health check for the Git service plugin.",
        "enabled": True,
        "recipe_ingredients": [
            {
                "service_type": "git",
...
GIT_SCHEDULED_TASKS: tuple[JSONObject, ...] = (
    {
        "task_key": "plugin-health-check:git",
