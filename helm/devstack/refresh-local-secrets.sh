...
BAKERY_MONITOR_ID_CURRENT="${BAKERY_MONITOR_ID:-}"
BAKERY_BOOTSTRAP_HMAC_KEY_ID_CURRENT="${BAKERY_BOOTSTRAP_HMAC_KEY_ID:-}"
BAKERY_BOOTSTRAP_HMAC_KEY_CURRENT="${BAKERY_BOOTSTRAP_HMAC_KEY:-}"
BAKERY_MONITOR_UUID_CURRENT="${BAKERY_MONITOR_UUID:-}"
BAKERY_MONITOR_HMAC_KEY_ID_CURRENT="${BAKERY_MONITOR_HMAC_KEY_ID:-}"
BAKERY_MONITOR_HMAC_SECRET_CURRENT="${BAKERY_MONITOR_HMAC_SECRET:-}"
...
export BAKERY_MONITOR_ID=$(shell_quote "$BAKERY_MONITOR_ID_CURRENT")
export BAKERY_BOOTSTRAP_HMAC_KEY_ID=$(shell_quote "$BAKERY_BOOTSTRAP_HMAC_KEY_ID_CURRENT")
export BAKERY_BOOTSTRAP_HMAC_KEY=$(shell_quote "$BAKERY_BOOTSTRAP_HMAC_KEY_CURRENT")
export BAKERY_MONITOR_UUID=$(shell_quote "$BAKERY_MONITOR_UUID_CURRENT")
export BAKERY_MONITOR_HMAC_KEY_ID=$(shell_quote "$BAKERY_MONITOR_HMAC_KEY_ID_CURRENT")
export BAKERY_MONITOR_HMAC_SECRET=$(shell_quote "$BAKERY_MONITOR_HMAC_SECRET_CURRENT")
EOF
